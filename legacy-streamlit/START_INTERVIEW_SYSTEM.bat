...
REM Check if virtual environment exists. Prefer a venv beside the legacy app,
REM then fall back to the old repo-root venv if this folder was moved.
...
python -m pytest tests\test_interview_system.py -q
if errorlevel 1 (
    echo.
