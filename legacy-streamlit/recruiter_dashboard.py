...
AI_REVIEW_NOTICE = (
    "AI scores and proctoring risk indicators are review aids. They may be affected "
    "by answer quality, audio clarity, resume context, browser behavior, network "
    "conditions, camera quality, lighting, accessibility needs, or model limitations. "
    "Review the underlying answers and context before deciding."
)
...
def generate_candidate_pdf(session_id: int, org_id: str = None) -> bytes:
    ...
    story = [
        ...
        Paragraph(
            ...
            "Scores, recommendations, and proctoring indicators are decision-support "
            "signals only; final hiring decisions must be made by human reviewers.",
            cap_s,
        ),
        sp(6),
        Paragraph(
