    ...
    with main_col:
        ...
        if invited_candidate:
            ...
            <div style="background:#f8fafc;border:1px solid #cbd5e1;border-radius:12px;
                 padding:14px 18px;margin:16px 0 14px">
              <div style="font-size:11px;font-weight:800;color:#475569;
                   text-transform:uppercase;letter-spacing:0.7px;margin-bottom:6px">
                AI-assisted interview notice</div>
              <div style="font-size:13px;color:#334155;line-height:1.65">
                This interview may be transcribed and analyzed using AI-assisted tools.
                PsySense may generate structured scores and collect integrity signals such
                as tab switching, fullscreen exits, copy/paste attempts, and multiple-face
                detection. These outputs are reviewed by recruiters and are not final hiring
                decisions by themselves.
              </div>
            </div>""", unsafe_allow_html=True)
            invited_consent = st.checkbox(
                "I understand and agree to the AI-assisted interview, transcription, scoring, and integrity signal collection.",
                key="invited_candidate_consent",
            )
        ...
        candidate_consent = st.checkbox(
            "I understand and agree to the AI-assisted interview, transcription, scoring, and integrity signal collection.",
            key="candidate_consent",
        )
        ...
        with cta:
            if st.button("Generate Questions & Start Interview →",
                ...
                if not candidate_consent:
                    st.warning("Please confirm the interview notice before continuing.")
